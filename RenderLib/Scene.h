...
namespace render
{
	...
	*/
	...
	public:
		...
		*	La nouvelle valeur.
		*/
		inline void backgroundColour( gl::RgbaColour const & colour )noexcept
		{
		...
		*/
		inline gl::RgbaColour const & backgroundColour()const noexcept
		{
		...
		*/
		inline Range< float > const & thresholdBounds()const noexcept
		{
